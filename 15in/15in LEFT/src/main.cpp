...
void leftSafe() {
   //pros::Task colorSortTask(colorSort);
    ...
    chassis.moveToPoint(28,143-20,3000, {.maxSpeed = 60});  //Long movement to middle goal
    chassis.waitUntilDone();
    pros::delay(500);
    ...
    chassis.moveToPoint(7,143-21,1500, {.maxSpeed = 53});  //Matchload 1
    chassis.waitUntilDone();
    pros::delay(1000);
    ...
    chassis.moveToPoint(25,143-21,1500, {.forwards = false, .maxSpeed = 60});   //back away from Matchload 1
    chassis.turnToHeading(-45, 1000);

    chassis.moveToPoint(48,100,1500, {.forwards = false, .maxSpeed = 60});   //align to drive back
    chassis.turnToHeading(-90,1000);
    chassis.moveToPoint(96,100,1500, {.forwards = false, .maxSpeed = 90});   //drive by goal
    chassis.turnToHeading(45,1000);

    chassis.moveToPoint(120,124,1500, {.maxSpeed = 70});   //align to score
    chassis.turnToHeading(90,1000);



    chassis.moveToPoint(92,124,1500, {.forwards = false, .maxSpeed = 60});   //Long goal
    chassis.waitUntilDone();
    mainIntake.move_voltage(12000);
    indexerIntake.move_voltage(12000);
    scoringIntake.move_voltage(12000);
    ...
    chassis.moveToPoint(139,124,2000, {.maxSpeed = 55});  //Matchload 2
    ...
    chassis.moveToPoint(92,124,1500, {.forwards = false, .maxSpeed = 60});   //Long goal 2
    chassis.waitUntilDone();
    mainIntake.move_voltage(12000);
    indexerIntake.move_voltage(12000);
    scoringIntake.move_voltage(12000);
    ...
    chassis.moveToPoint(134,114,1000, {.maxSpeed = 60});  //move away from goal
    chassis.turnToHeading(180,1000);
    scoringIntake.move_voltage(0);

    chassis.moveToPoint(138,54,1000, {.maxSpeed = 90});  //Park
}
